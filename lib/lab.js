...
const PICKS=["mini-cooper","fiat-500-1-2","my","ford-transit-custom-2-0-ecoblue-130",
             "ford-focus-1-0-ecoboost-125","bmw-320d-g20"];
...
<p class="lede">Round two was the <b>shape</b>, which is what was actually wrong.
Twelve outlines were authored in one sitting; <b>four survived</b>. The four below are
the ones that beat the generic archetype they replaced &mdash; all of them two-box
shapes defined by proportion. The eight that lost were the car-shaped ones, where an
archetype tuned over months is a harder thing to beat than it looks.</p>
