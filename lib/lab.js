...
const PICKS=["chiron","chevrolet-camaro-g6-zl1-1le","lamborghini-countach-5000-qv",
             "mini-cooper","fiat-500-1-2","my","ford-transit-custom-2-0-ecoblue-130",
             "fiestast","bmw-320d-g20","ford-focus-1-0-ecoboost-125","992ts","m3p"];
...
<p class="lede">Round two, and this time it is the <b>shape</b>, which is what was
actually wrong. Left is what the car looks like today. Middle is an outline authored
for that specific car. Right adds the lighting from round one. Twelve new outlines,
written in one sitting &mdash; the question this page exists to answer is whether that
rate is worth continuing at.</p>
